      ...
      <table className="min-w-full table-auto text-left hidden md:table">
        ...
        <tbody className="text-gray-700">
          {customerData?.length > 0 ? (
              ...
              <tr key={customer._id} className="border-b hover:bg-gray-50">
                ...
                <td className="py-3 px-6">
                  <div className="flex gap-2">
                    {/* <Link to={`/edit-customer/${customer._id}?name=${customer.name}&mobile=${customer.mobile}&address=${customer.address}`}> */}
                    <AtmButtonField
                      label="Edit"
                      onClick={() => hendelEdit(customer._id)}
            ...
            <tr>
              <td colSpan={4} className="py-3 px-6 text-center">No customers available</td>
            </tr>
          )}
        </tbody>
      </table>
